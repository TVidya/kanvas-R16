...
public class KanvasLoginCID008CustomFunctions {
	@Keyword
	...
	def KLogin(){
		...
		WebUI.setText(findTestObject('Object Repository/Final objects/Login credentials/input_user'), GlobalVariable.CID008_usn)
		WebUI.setText(findTestObject('Object Repository/Final objects/Login credentials/input_encPass'), GlobalVariable.CID008_pwd)
